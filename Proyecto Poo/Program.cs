            ...
            while (true) //Inicio Menu Simulacion
            {
                ...
                else if (opc1 == "1")//Opcion Estudiante
                {
                    ...
                    while (true)
                    {
                        ...
                        Console.WriteLine("2.Arrendar Sala");
                        Console.WriteLine("3.Desocupar Sala");
                        Console.WriteLine("4.Arrendar Accesorio");
                        Console.WriteLine("5.Pagar y Volver al menu");

                        opc1 = Console.ReadLine();
                        while (opc1 != "1" && opc1 != "2" && opc1 != "3" && opc1 != "4" && opc1 != "5")
                        {
                            Console.WriteLine("Opcion Ingresada NO es Valida");
                            Console.Beep();
                        ...
                        else if (opc1 == "2")//Arrendar Salas
                        {
                            ...
                            if (opc1 == "1")//Arrendadndo en Reloj
                            {
                                ...
                                while (true)
                                {
                                    ...
                                    if (esta)
                                    {
                                        persona.OcuparSala(salaA, Reloj);
                                        salaA.quienArrendo = persona;
                        ...
                        else if (opc1 == "3")//Desocupar Sala
                        {
                            ...
                            while (true)
                            {
                                ...
                                Console.WriteLine("Error, ingrese su sala ocupada");
                            }

                        }
                        else if (opc1 == "4")//Arrendar Accesorio
                        {
